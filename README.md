...
I developed even a file system analyzer for the frontend projects (configurable for many other, not only frontend) using Rust, that makes different structure in .json format to visualize immediatly with the help of some .json visualizer like [Json Crack](https://jsoncrack.com/), for internal use of Gamindo. The structures can be for example the tree of the dependencies or the project tree based on files and directories.
